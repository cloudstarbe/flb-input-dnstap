...
static const ProtobufCEnumValue dnstap__socket_protocol__enum_values_by_number[7] =
{
  ...
  { "DNSCryptUDP", "DNSTAP__SOCKET_PROTOCOL__DNSCryptUDP", 5 },
  { "DNSCryptTCP", "DNSTAP__SOCKET_PROTOCOL__DNSCryptTCP", 6 },
  { "DOQ", "DNSTAP__SOCKET_PROTOCOL__DOQ", 7 },
};
static const ProtobufCIntRange dnstap__socket_protocol__value_ranges[] = {
{1, 0},{0, 7}
};
static const ProtobufCEnumValueIndex dnstap__socket_protocol__enum_values_by_name[7] =
{
  { "DNSCryptTCP", 5 },
  { "DNSCryptUDP", 4 },
  { "DOH", 3 },
